...
def DisplayForm():
    ...
    display_screen.title("CONTACT APPLICATION")
    global tree
    global SEARCH
    ...
    LFrom = Frame(display_screen, width="350",bg="#14abde")
    ...
    #label for heading
    lbl_text = Label(TopViewForm, text="Contact Application", font=('verdana', 18), width=600,bg="yellow")
...
def register():
    ...
    if fname1=='' or lname1==''or gender1=='' or address1==''or contact1=='':
        ...
        #execute query
        conn.execute('INSERT INTO REGISTRATION (FNAME,LNAME,GENDER,ADDRESS,CONTACT) VALUES (?,?,?,?,?)',(fname1,lname1,gender1,address1,contact1));
        conn.commit()
